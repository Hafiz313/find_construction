...
Future<LoginModel> conformPassword(String password, String conformPassword, String id) async {
  final String apiUrl =
  ...
  if (response.statusCode == 200) {
    ...
    print("------------------conform password r ${response.body}--------------------------");
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      validator: (String value) {
                        ...
                        else strConformPassword = value.toString().trim();
                      ...
                      child: FlatButton(
                        ...
                        onPressed: () async {
                          if (_formKey.currentState.validate()) {
                            ...
                            print("-------------Share Pre User id $id and $strPassword---------------");
                            LoginModel login = await conformPassword(strPassword,strConformPassword,id);
